...
public interface NdsIdentity {
     ...
     *
     * <p>[Behavior] Policy resolution semantics are implementation-defined.</p>
     *
     * @return attached policy IDs (may be empty; never null)
     * @since 2.2.0
     */
    default List<String> attachedPolicyIds() {
        return List.of();
    }
    ...
    /**
     * Create a copy with new attached policy IDs (immutability helper).
     *
     * @param attachedPolicyIds attached policy IDs (may be null)
     * @return new identity instance
     * @since 2.2.0
     */
    default NdsIdentity withAttachedPolicyIds(List<String> attachedPolicyIds) {
        return this;
    }
    ...
    static NdsIdentity of(String id, IdentityType type) {
        return new NdsIdentityImpl(id, type, Map.of(), List.of()); // [Index] NDS-JAVA-IDENTITY-011 [Behavior] Lightweight value object creation (no IO).
    }
}
